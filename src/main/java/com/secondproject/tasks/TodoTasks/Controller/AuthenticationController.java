...
//	@Autowired
//	private JwtTokenGenerate jwtgenerateToken;
...
//	@PostMapping("/login")
//	public ResponseEntity<JwtObjectResponse> loginEmployee(@RequestBody LoginDto logins) {
//	    Authentication authentication = authenticationManager.authenticate(
//	            new UsernamePasswordAuthenticationToken(logins.getEmail(), logins.getPassword())
//	    );
//	    SecurityContextHolder.getContext().setAuthentication(authentication);
//	    if(authentication.isAuthenticated()) {
//		    String jwtToken = jwtgenerateToken.getToken(authentication);
//		    return ResponseEntity.ok(new JwtObjectResponse(jwtToken));	    	
//	    }else {
